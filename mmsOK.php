...
<html>
    <head>
        <meta charset="UTF-8">
        <title>마이페이지-미션 설정-아침 미션 설정-추가성공</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
        <link rel="stylesheet" href="mmsOK.css">
        <!-- ✅ Noto Sans KR 웹폰트 추가 -->
    ...
    <body>
        ...
        <div class="centerContainer">
            ...
            <div id="backButton">
                <button class="mmsOKBackButton" data-url="myMissionSettings.php">
                    돌아가기
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        document.querySelectorAll(".mmsOKBackButton").forEach(button => {
            button.addEventListener("click", () => {
                const targetUrl = button.getAttribute("data-url");
                window.location.href = targetUrl;
            });
